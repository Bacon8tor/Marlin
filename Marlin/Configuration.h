...
#define STRING_CONFIG_H_AUTHOR "Bacon8tor" // Who made the changes.
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     57       // LED driving pin
  ...
  #define NEOPIXEL_BRIGHTNESS 0  // Initial brightness (0-255)
